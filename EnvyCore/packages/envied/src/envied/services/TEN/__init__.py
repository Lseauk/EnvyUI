...
class TEN(Service):
    ...
    def get_tracks(self, title: Union[Movie, Episode]) -> Tracks:
        ...
        title.data["chapters"] = stream_data.get("time_events_url") if isinstance(stream_data, dict) else None

        manifest_url = stream_data.get("stream_manifest") if isinstance(stream_data, dict) else None
